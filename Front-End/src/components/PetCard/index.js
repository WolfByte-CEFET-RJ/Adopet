...
export default function PetCard({image, uri, name, adopted, onPress, activeOpacity,little}) {

  return(
    <Pet activeOpacity={activeOpacity ? activeOpacity : 0.8} onPress={onPress} little={little}>
